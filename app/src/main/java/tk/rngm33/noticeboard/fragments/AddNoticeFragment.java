                    ...
                    public void onClick(View view) {
                        if (auth.getCurrentUser() != null) {
                            ...
                            if (nameEditTxt.getText().toString().isEmpty()) {
                                ...
                                m.setName(user.getEmail());
//                                MyFirebaseMessagingService myFirebaseMessagingService= new MyFirebaseMessagingService(titleEditTxt.getText().toString(),nameEditTxt.getText().toString());
