...
//        getSupportActionBar().setTitle("User Dashboard");
        ...
        drawerLayout = findViewById(R.id.draweriduser);
        ...
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        nv = findViewById(R.id.navigationviewuser);

        // navigate to HomeUserFragment when activity is created
        navigateFragment(new HomeUserFragment());
    ...
    private void navigateFragment(Fragment fragment) {
        ...
        ft.replace(R.id.frguser, fragment);
        ft.commit();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.usermenuview, menu);
